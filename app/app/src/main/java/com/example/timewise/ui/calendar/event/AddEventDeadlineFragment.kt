...
// Packages required by AddEventDeadlineFragment class
...
import com.example.timewise.databinding.AddEventDeadlineBinding
...
// AddEventDeadlineFragment class to add a deadline event
class AddEventDeadlineFragment : Fragment() {
    // Binding section
    private var _binding: AddEventDeadlineBinding? = null
    ...
    // Method to create the add event deadline fragment
    ...
    // Method to create the view of the add event deadline fragment
    override fun onCreateView(
        ...
        _binding = AddEventDeadlineBinding.inflate(inflater, container, false)
        ...
        buttonSave.setOnClickListener {
            ...
            if (name.isEmpty() || time.isEmpty()) {
                ...
                // Set the data of the event in the calendar
                event.time?.let { it1 ->
                    calendar.set(
                ...
                findNavController().navigate(R.id.action_addEventDeadlineFragment_to_dayFragment)
            }
    ...
    private fun showTimePickerDialog() {
        // Create the listener for the time picker dialog
    ...
    // Method to destroy the view of the add event deadline fragment
