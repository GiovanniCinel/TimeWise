...
// Packages required by ModifyEventDeadlineFragment class
...
import com.example.timewise.databinding.ModifyEventDeadlineBinding
...
// ModifyEventDeadlineFragment class to modify a deadline event
class ModifyEventDeadlineFragment : Fragment() {
    // Binding section
    private var _binding: ModifyEventDeadlineBinding? = null
    ...
    // Method to create the modify event deadline fragment
    ...
    private fun fillDeadlineEventInput() {
    ...
    // Method to create the modify event deadline fragment view
    override fun onCreateView(
        ...
        _binding = ModifyEventDeadlineBinding.inflate(inflater, container, false)
        ...
        binding.buttonSave.setOnClickListener {
            ...
            if (name.isEmpty() || time.isEmpty()) {
                ...
                // Set desired time (in 24 hour format)
                updatedEvent.time?.let { it1 ->
                    calendar.set(
                        Calendar.MINUTE,
                        it1.minute
                ...
                findNavController().navigate(R.id.action_modifyEventDeadlineFragment_to_dayFragment)
            }
        }
    ...
    // Method to destroy the modify event deadline fragment view
