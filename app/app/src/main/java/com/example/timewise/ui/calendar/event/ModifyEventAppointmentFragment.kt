...
// Packages required by ModifyEventAppointmentFragment class
...
import com.example.timewise.databinding.ModifyEventAppointmentBinding
...
// ModifyEventAppointmentFragment class to modify an appointment event
class ModifyEventAppointmentFragment : Fragment() {
    // Binding section
    private var _binding: ModifyEventAppointmentBinding? = null
    ...
    // Method to create the modify event appointment fragment
    ...
    private fun fillAppointmentEventInput() {
    ...
    // Method to create the modify event appointment fragment view
    override fun onCreateView(
        ...
        _binding = ModifyEventAppointmentBinding.inflate(inflater, container, false)
        ...
        binding.buttonSave.setOnClickListener {
            ...
            if (name.isEmpty() || time.isEmpty()) {
                ...
                findNavController().navigate(R.id.action_modifyEventAppointmentFragment_to_dayFragment)
            }
        }
